...
if ($selected_student_id) {
    $proc->deleteStudent($_SESSION['classID'], $selected_student_id);
...
$stmt3 = $conn->prepare("CALL get_enrolled(?, ?)");
...
<div class="card">
    <div class="card-header">
        <h5 class="mb-0">Remove Students from Class</h5>
    </div>
    <div class="card-body">
        <div class="card mt-4">
            <div class="card-header">
        ...
        <form method="post" action="">
            <div class="form-group mb-3">
                <label for="student_id">Student to be removed from the class list:</label>
            ...
            <div class="d-flex justify-content-end gap-2">
                ...
                <button type="submit" name="submit" class="btn btn-danger">Remove Student</button>
            </div>
        </form>
    </div>
    <style>
